...
@Data
@Schema(name = "AccountRequest", description = "Representa una cuenta de usuario para registrar")
public class AccountRequest {
    @Schema(name = "firstName", requiredMode = RequiredMode.REQUIRED, example = "John", description = "Nombres del usuario")
    @NotBlank(message = "Su nombre es obligatorio")
    @Size(min = 3, max = 25, message = "El nombre debe tener entre 3 y 25 caracteres")
    private String firstName;

    @Schema(name = "lastName", requiredMode = RequiredMode.REQUIRED, example = "Doe", description = "Apellidos del usuario")
    ...
    @Schema(name = "password", requiredMode = RequiredMode.REQUIRED, example = "********", description = "Contraseña del usuario")
    ...
    @Schema(name = "passwordConfirmation", requiredMode = RequiredMode.REQUIRED, example = "********", description = "La misma contraseña del usuario")
